...
{
    private readonly List<Domain.SiegeEngines.Model.Cannon> _cannons = new();
    private readonly Dictionary<string, ICannonFactory> _factories = new();

    public void RegisterCannon(Domain.SiegeEngines.Model.Cannon cannon, ICannonFactory factory)
    {
        _cannons.Add(cannon);
