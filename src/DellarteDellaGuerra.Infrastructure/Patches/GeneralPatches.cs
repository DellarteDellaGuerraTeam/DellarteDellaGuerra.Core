...
public class GeneralPatches : IPatch
{
    public MethodInfo? TargetMethod =>
        AccessTools.Method(typeof(MissionSettlementPrepareView), "SetOwnerBanner");

    public MethodInfo? PatchMethod =>
        AccessTools.Method(typeof(GeneralPatches), nameof(MissionSettlementPrepareView_SetOwnerBanner_Patch));
    ...
    /// </summary>
    private static bool MissionSettlementPrepareView_SetOwnerBanner_Patch(MissionSettlementPrepareView __instance)
    {
