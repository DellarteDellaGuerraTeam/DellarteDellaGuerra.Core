...
public class BattleEquipmentRepositoryShould
{
    [Test]
    public void GetCharacterEquipment()
    {
        var equipmentRepository = EquipmentRepositoryReturns(new Dictionary<string, IList<Domain.EquipmentPool.Model.EquipmentPool>>
        {
            {
        ...
        var battleEquipmentRepository = new BattleEquipmentRepository(equipmentRepository, siegeEquipmentRepository,
            civilianEquipmentRepository);

        var characterBattleEquipment = battleEquipmentRepository.GetBattleEquipmentByCharacterAndPool();

        Assert.That(characterBattleEquipment, Is.EqualTo(new Dictionary<string, IList<Domain.EquipmentPool.Model.EquipmentPool>>
        {
            {
                "Character1", new List<Domain.EquipmentPool.Model.EquipmentPool>
                {
    ...
    private Domain.EquipmentPool.Model.Equipment CreateEquipment(string id)
    {
        ...
        return new Domain.EquipmentPool.Model.Equipment(XDocument.Parse(xml).Root!);
    }
}