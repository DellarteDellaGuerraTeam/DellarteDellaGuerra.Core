...
namespace DellarteDellaGuerra.Equipment.Get.MissionLogic
{
    ...
    public class MissionAgentSpawnLogicBuilder
    {
         ...
         * </summary>
         * <param name="getTroopEquipment">The troop equipment provider.</param>
         * <param name="equipmentPoolMapper">The equipment pool mapper.</param>
         * <returns>The MissionAgentSpawnLogicBuilder instance.</returns>
         */
        public MissionAgentSpawnLogicBuilder UseExpandedEquipmentRandomisation(IGetTroopEquipment getTroopEquipment,
            EquipmentPoolMapper equipmentPoolMapper)
        {
            ...
            //     new TroopEquipmentRandomisationDecorator(decoratedMissionTroopSupplier(mapEvent, battleSide),
            //         getTroopEquipment, equipmentPoolMapper);
            _decoratedTroopSupplier = (mapEvent, battleSide) =>
                new TroopEquipmentRandomisationDecorator(new PartyGroupTroopSupplier(mapEvent, battleSide),
                    getTroopEquipment, equipmentPoolMapper);
            return this;
        }
