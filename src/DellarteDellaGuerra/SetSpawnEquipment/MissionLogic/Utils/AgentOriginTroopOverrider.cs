...
namespace DellarteDellaGuerra.SetSpawnEquipment.MissionLogic.Utils
{
    ...
    internal class AgentOriginTroopOverrider : IAgentOriginBase
    {
        ...
        {
            _agentOriginBase.SetWounded();
        }

        public void SetKilled()
        {
            _agentOriginBase.SetKilled();
        }

        public void SetRouted()
        {
            _agentOriginBase.SetRouted();
        }

        public void OnAgentRemoved(float agentHealth)
        {
            _agentOriginBase.OnAgentRemoved(agentHealth);
        }
        ...
        {
            _agentOriginBase.SetBanner(banner);
        }
